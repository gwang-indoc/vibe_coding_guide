...
| [Claude Code: Context Management Strategy](ai-tools/claude-code-context-management.md) | Explore→plan→clear→execute; dumb zone ~40%; rewind (double-Esc//rewind) over in-context correction; compact at phase boundaries | 2026-06-10 |
